-- Force refresh views to clear linter cache
-- Drop and recreate all three views to ensure cache invalidation
...
-- Add comments
COMMENT ON VIEW public.public_listings IS 'Public view of active listings - no SECURITY DEFINER';
COMMENT ON VIEW public.public_safe_profiles IS 'Public view of active profiles - no SECURITY DEFINER';
COMMENT ON VIEW public.public_reviews IS 'Public view of reviews - no SECURITY DEFINER';